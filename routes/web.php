...
Route::get('/categorie/{slug}', 'FrontEndController@category')->name('website.category');
Route::get('/tag/{slug}', 'FrontEndController@tag')->name('website.tag');
Route::get('/contact', 'FrontEndController@contact')->name('website.contact');
Route::get('/articles', 'FrontEndController@posts')->name('website.posts');
Route::get('/article/{slug}', 'FrontEndController@post')->name('website.post');
