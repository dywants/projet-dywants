...
class FrontEndController extends Controller
{
    public function home(){
        ...
        return view('website.homepage', compact('posts', 'recentPosts', 'firstPosts2', 'middlePost', 'lastPosts'));
    }

    public function posts(){
        Carbon::setLocale('fr');
        $allPosts = Post::with('category', 'user')->orderBy('created_at', 'DESC')->paginate(9);
        return view('website.posts', compact('allPosts'));
    }
