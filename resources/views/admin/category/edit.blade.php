...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Editer Categorie</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('website') }}">Accueuil</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('category.index') }}">Liste Categories</a></li>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex justify-content-between align-items-center">
                                <h3 class="card-title">Editer Categorie - {{ $category->name }}</h3>
                                <a href="{{ route('category.index') }}" class="btn btn-primary">Retour sur
                                    liste Categories</a>
                            </div>
                        </div>
